...
# POLICY_NAVIGATOR_COMPLIANCE_APP = os.getenv('POLICY_NAVIGATOR_APP')
# POLICY_NAVIGATOR_CLINICAL_GUIDELINES_APP = os.getenv('POLICY_NAVIGATOR_APP')
# POLICY_NAVIGATOR_HR_APP = os.getenv('POLICY_NAVIGATOR_APP')

# policy_navigator_engine = f"projects/{PROJECT_ID}/locations/{LOCATION}/collections/{COLLECTION_ID}/engines/{POLICY_NAVIGATOR_APP}"
# policy_navigator_compliance_engine = f"projects/{PROJECT_ID}/locations/{LOCATION}/collections/{COLLECTION_ID}/engines/{POLICY_NAVIGATOR_COMPLIANCE_APP}"
# policy_navigator_clinical_engine = f"projects/{PROJECT_ID}/locations/{LOCATION}/collections/{COLLECTION_ID}/engines/{POLICY_NAVIGATOR_CLINICAL_GUIDELINES_APP}"
# policy_navigator_hr_engine = f"projects/{PROJECT_ID}/locations/{LOCATION}/collections/{COLLECTION_ID}/engines/{POLICY_NAVIGATOR_HR_APP}"
...
#         policy_navigator_compliance_tool,
#         policy_navigator_clinical_tool,
#         policy_navigator_hr_tool,
#     ],
